    ...
    describe('EthersMode', () => {
        ...
        describe('address', () => {
            ...
            it('should _also_ accept valid signers while tracking symbols', () => {
                ...
                expect(mode.thisPrivateKey).to.be.equal(
                ...
                mode.address(
                    '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80 as signer'.asAddress()
                );
                expect(mode.thisPrivateKey).to.be.equal(
                    '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80'
                );
            ...
            it('should reject duplicated address alias definitions', () => {
                ...
                expect(() => mode.address('0x70997970C51812dc3A010C7d01b50e0d17dc79C8 as token'.asAddress())).to.throw(
                    'identifier `token` already defined'
                );
                expect(mode.symbols).to.be.have.property('this', '0x5425890298aed601595a70AB815c96711a31Bc65');
                expect(mode.symbols).to.be.have.property('token', '0x5425890298aed601595a70AB815c96711a31Bc65');
            });
        ...
        describe('call', () => {
            ...
            it('should reject undefined signer', () => {
                ...
                expect(() => mode.call('method(2)'.asCall())).to.throw('sending a transaction requires a signer');
